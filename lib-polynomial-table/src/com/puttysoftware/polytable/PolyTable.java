 ...
 */
package com.puttysoftware.polytable;
...
public final class PolyTable extends Polynomial {
    ...
    public PolyTable(final int maxPower, final int params, final int range,
    ...
    public static PolyTable readPage(final XDataReader reader)
            throws IOException {
